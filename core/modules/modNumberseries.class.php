...
/**
 * 	\defgroup	numberseries	numberseries module
 * 	\brief		numberseries module descriptor.
 * 	\file		core/modules/modnumberseries.class.php
 * 	\ingroup	numberseries
 * 	\brief		Description and activation file for module numberseries
 */
 ...
 */
class modNumberseries extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->rights_class = 'numberseries';
		...
		// (where XXX is value of numeric property 'numero' of module)
		$this->description = "Description of module numberseries";
		// Possible values for version are: 'development', 'experimental' or version
		$this->version = '4.0';
		// Key used in llx_const table to save module status enabled/disabled
		// (where numberseries is value of property name of module in uppercase)
		...
		$this->picto = 'numberseries@numberseries'; // mypicto@numberseries
		// Defined all module parts (triggers, login, substitutions, menus, css, etc...)
		// for default path (eg: /numberseries/core/xxxxx) (0=disable, 1=enable)
		// for specific path of parts (eg: /numberseries/core/modules/barcode)
		// for specific css file (eg: /numberseries/css/numberseries.css.php)
		$this->module_parts = array(
			...
			'css' => array('numberseries/css/numberseries.css'),
		...
		// Example: this->dirs = array("/numberseries/temp");
		$this->dirs = array();

		// Config pages. Put here list of php pages
		// stored into numberseries/admin directory, used to setup module.
		$this->config_page_url = array("admin.php@numberseries");
		...
		// Language files list (langfiles@numberseries)
		$this->langfiles = array("numberseries@numberseries");
		// Constants
		...
		// Dictionaries
		if (! isset($conf->numberseries->enabled)) {
			$conf->numberseries=new stdClass();
			$conf->numberseries->enabled = 0;
		}
		...
		//$this->rights[$r][0] = 4000221;
		//// Permission label
		//$this->rights[$r][1] = 'Create series';
	...
	public function init($options = '')
	{
		...
		$param = array();
		$quer = 'numberseries:ref:rowid:: typedoc = 1 AND entity = '.$conf->entity;
		$param['options'][$quer] = '';
		$extra->addExtraField("serie", "Número de serie", "sellist", 1, "", "facture",0,1,"",$param);
		
		$param = array();
		$quer = 'numberseries:ref:rowid:: typedoc = 2 AND entity = '.$conf->entity;
		$param['options'][$quer] = '';
		$extra->addExtraField("serie", "Número de serie", "sellist", 1, "", "facture_fourn",0,1,"",$param);
		
		$param = array();
		$quer = 'numberseries:ref:rowid:: typedoc = 3 AND entity = '.$conf->entity;
		$param['options'][$quer] = '';
		$extra->addExtraField("serie", "Número de serie", "sellist", 1, "", "commande",0,1,"",$param);
		
		$param = array();
		$quer = 'numberseries:ref:rowid:: typedoc = 4 AND entity = '.$conf->entity;
		$param['options'][$quer] = '';
		$extra->addExtraField("serie", "Número de serie", "sellist", 1, "", "commande_fournisseur",0,1,"",$param);
		
		$param = array();
		$quer = 'numberseries:ref:rowid:: typedoc = 5 AND entity = '.$conf->entity;
		$param['options'][$quer] = '';
		$extra->addExtraField("serie", "Número de serie", "sellist", 1, "", "propal",0,1,"",$param);
	...
	{
		return $this->_load_tables('/numberseries/sql/');
	}
}
